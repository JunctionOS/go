...
//go:build aix || darwin || dragonfly || freebsd || (linux || junction) || netbsd || openbsd || solaris || windows
// +build aix darwin dragonfly freebsd linux junction netbsd openbsd solaris windows
