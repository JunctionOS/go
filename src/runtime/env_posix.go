...
//go:build aix || darwin || dragonfly || freebsd || (js && wasm) || (linux || junction) || netbsd || openbsd || solaris || windows || plan9
// +build aix darwin dragonfly freebsd js,wasm linux junction netbsd openbsd solaris windows plan9
