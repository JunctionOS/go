...
//go:build !aix && !darwin && !dragonfly && !freebsd && !(linux || junction) && !netbsd && !openbsd && !windows
// +build !aix,!darwin,!dragonfly,!freebsd,!linux,!netbsd,!openbsd,!windows !aix,!darwin,!dragonfly,!freebsd,!junction,!netbsd,!openbsd,!windows
