...
func BuildModeSupported(compiler, buildmode, goos, goarch string) bool {
	...
	case "c-shared":
		switch platform {
		case "linux/amd64", "linux/arm", "linux/arm64", "linux/386", "linux/ppc64le", "linux/riscv64", "linux/s390x", "junction/amd64",
	...
	case "pie":
		switch platform {
		case "linux/386", "junction/amd64", "linux/amd64", "linux/arm", "linux/arm64", "linux/ppc64le", "linux/riscv64", "linux/s390x",
			"android/amd64", "android/arm", "android/arm64", "android/386",
			"freebsd/amd64",
			"darwin/amd64", "darwin/arm64",
			"ios/amd64", "ios/arm64",
...
func InternalLinkPIESupported(goos, goarch string) bool {
	...
	case "darwin/amd64", "darwin/arm64",
		"junction/amd64", "linux/amd64", "linux/arm64", "linux/ppc64le",
		"android/arm64",
