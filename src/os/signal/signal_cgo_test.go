...
//go:build (darwin || dragonfly || freebsd || ((linux || junction) && !android) || netbsd || openbsd) && cgo
// +build darwin dragonfly freebsd linux,!android junction,!android netbsd openbsd
// +build cgo
