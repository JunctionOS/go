...
//go:build (aix || darwin || dragonfly || freebsd || (js && wasm) || (!android && (linux || junction)) || netbsd || openbsd || solaris) && (!cgo || osusergo)
// +build aix darwin dragonfly freebsd js,wasm !android,linux !android,junction netbsd openbsd solaris
// +build !cgo osusergo
