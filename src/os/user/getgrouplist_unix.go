...
//go:build (dragonfly || freebsd || (!android && (linux || junction)) || netbsd || openbsd || (solaris && !illumos)) && cgo && !osusergo
// +build dragonfly freebsd !android,linux !android,junction netbsd openbsd solaris,!illumos
// +build cgo
// +build !osusergo
