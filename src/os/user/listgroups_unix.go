...
//go:build (dragonfly || darwin || freebsd || (!android && (linux || junction)) || netbsd || openbsd || (solaris && !illumos)) && cgo && !osusergo
// +build dragonfly darwin freebsd !android,linux !android,junction netbsd openbsd solaris,!illumos
// +build cgo
// +build !osusergo
