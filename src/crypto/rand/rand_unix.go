...
//go:build aix || darwin || dragonfly || freebsd || (linux || junction) || netbsd || openbsd || plan9 || solaris
// +build aix darwin dragonfly freebsd linux junction netbsd openbsd plan9 solaris
