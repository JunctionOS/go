...
//go:build boringcrypto && (linux || junction) && amd64 && !android && !cmd_go_bootstrap && !msan
// +build boringcrypto,linux,amd64,!android,!cmd_go_bootstrap,!msan boringcrypto,junction,amd64,!android,!cmd_go_bootstrap,!msan
