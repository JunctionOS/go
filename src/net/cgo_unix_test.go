...
//go:build cgo && !netgo && (aix || darwin || dragonfly || freebsd || (linux || junction) || netbsd || openbsd || solaris)
// +build cgo
// +build !netgo
// +build aix darwin dragonfly freebsd linux junction netbsd openbsd solaris
